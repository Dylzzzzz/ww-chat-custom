...
export default {
    ...
    dropzones: [
        {
            ...
            data: {
                ...
                options: content => {
                    ...
                    const mapping = content?.mappingMessageMentions;
                    const message = __pickTemplateMessageByMapping(messages, mapping);
                    // Get the first mention from the message for the template
                    const mentions = message?.mentions || [];
                    return { template: mentions.length > 0 ? mentions[0] : {} };
                },
            },
        },
    ],
    editor: {
        label: { en: 'Custom Chat' },
        icon: 'chat',
        navigator: {
            groups: ["Dropzone"],
        },
    ...
    triggerEvents: [
        ...
        },
        {
            ...
            label: { en: 'On mention dropdown opened' },
            event: {},
        },
        {
            name: 'mentionDropdownClosed',
            label: { en: 'On mention dropdown closed' },
            event: {},
        },
    ],
    actions: [
    ...
    properties: {
        // Dropzone content storage (hidden from UI)
        'mention-template': {
            hidden: true,
            defaultValue: [],
            navigator: {
        ...
        mentionEnabled: {
            ...
            bindingValidation: {
                type: 'boolean',
                tooltip: 'Whether to enable the @mention system',
            },
            propertyHelp: {
                tooltip:
                    'Enables the @mention system for referencing records in messages.\n\nPossible values: `true`, `false`',
            },
            /* wwEditor:end */
        },
        ...
        mentionRecordTypes: {
            ...
            defaultValue: [
                {
                    ...
                    icon: 'user',
                    records: [
                        { id: '1', label: 'John Doe', avatar: '', metadata: {} },
                        { id: '2', label: 'Jane Smith', avatar: '', metadata: {} },
                        { id: '3', label: 'Bob Johnson', avatar: '', metadata: {} },
                    ],
                },
                {
                    id: 'projects',
                    ...
                    icon: 'folder',
                    records: [
                        { id: 'p1', label: 'Website Redesign', avatar: '', metadata: {} },
                        { id: 'p2', label: 'Mobile App', avatar: '', metadata: {} },
                        { id: 'p3', label: 'Marketing Campaign', avatar: '', metadata: {} },
                    ],
                },
                {
                    id: 'tasks',
                    ...
                    icon: 'check-square',
                    records: [
                        { id: 't1', label: 'Update documentation', avatar: '', metadata: {} },
                        { id: 't2', label: 'Fix bug #123', avatar: '', metadata: {} },
                        { id: 't3', label: 'Review pull request', avatar: '', metadata: {} },
                    ],
                },
            ],
            options: {
                item: {
                    ...
                    options: {
                        item: {
                            id: { type: 'Text', label: { en: 'ID' }, defaultValue: '' },
                            label: { type: 'Text', label: { en: 'Label' }, defaultValue: '' },
                            icon: { type: 'Text', label: { en: 'Icon' }, defaultValue: '' },
                            records: { type: 'Array', label: { en: 'Records' }, defaultValue: [] },
                        },
                    },
                },
            },
            ...
            bindingValidation: {
                type: 'array',
                tooltip: 'Array of record type objects that can be mentioned',
            },
            propertyHelp: {
                tooltip:
                    'List of record types available for @mentioning.\n\nEach record type should include id, label, icon, and records array.\n\nExample:\n```json\n[{\n  "id": "tasks",\n  "label": "Tasks",\n  "icon": "check-square",\n  "records": [\n    { "id": "task-1", "label": "Complete design", "avatar": "", "metadata": {} }\n  ]\n}]\n```',
            },
            /* wwEditor:end */
            hidden: content => !content.mentionEnabled,
        },
        ...
        mappingRecordTypeId: {
            ...
            section: 'settings',
            /* wwEditor:start */
            bindingValidation: { type: 'formula', tooltip: 'Formula to extract the record type ID' },
            propertyHelp: {
                tooltip:
                    'Mapping to the unique record type ID.\n\nExample mapping: `context.mapping?.["id"]`\nExample value: `tasks`',
            },
            /* wwEditor:end */
            hidden: (content, _, boundProps) => !content.mentionEnabled || !boundProps.mentionRecordTypes,
        },

        mappingRecordTypeLabel: {
            label: { en: 'Record Type Label' },
            type: 'Formula',
            defaultValue: { type: 'f', code: "context.mapping?.['label'] ?? context.mapping?.['name']" },
            section: 'settings',
            /* wwEditor:start */
            bindingValidation: { type: 'formula', tooltip: 'Formula to extract the record type display label' },
            propertyHelp: {
                tooltip:
                    'Mapping to the record type display name.\n\nExample mapping: `context.mapping?.["label"]`\nExample value: `Tasks`',
            },
            /* wwEditor:end */
            hidden: (content, _, boundProps) => !content.mentionEnabled || !boundProps.mentionRecordTypes,
        },
        ...
        mappingRecordTypeIcon: {
            ...
            section: 'settings',
            /* wwEditor:start */
            bindingValidation: { type: 'formula', tooltip: 'Formula to extract the record type icon identifier' },
            propertyHelp: {
                tooltip:
                    'Mapping to the record type icon.\n\nExample mapping: `context.mapping?.["icon"]`\nExample value: `check-square`',
            },
            /* wwEditor:end */
            hidden: (content, _, boundProps) => !content.mentionEnabled || !boundProps.mentionRecordTypes,
        },
        ...
        mappingRecordTypeRecords: {
            ...
            type: 'Formula',
            defaultValue: { type: 'f', code: "context.mapping?.['records'] ?? context.mapping?.['items']" },
            section: 'settings',
            /* wwEditor:start */
            bindingValidation: { type: 'formula', tooltip: 'Formula to extract the array of records for this type' },
            propertyHelp: {
                tooltip:
                    'Mapping to the records array for this type.\n\nExample mapping: `context.mapping?.["records"]`\nExample value: `[{ id: "task-1", label: "Complete design" }]`',
            },
            /* wwEditor:end */
            hidden: (content, _, boundProps) => !content.mentionEnabled || !boundProps.mentionRecordTypes,
        },
        ...
        mappingRecordId: {
            ...
            section: 'settings',
            /* wwEditor:start */
            bindingValidation: { type: 'formula', tooltip: 'Formula to extract the record ID' },
            propertyHelp: {
                tooltip:
                    'Mapping to the unique record ID.\n\nExample mapping: `context.mapping?.["id"]`\nExample value: `task-1`',
            },
            /* wwEditor:end */
            hidden: (content, _, boundProps) => !content.mentionEnabled || !boundProps.mentionRecordTypes,
        },
        ...
        mappingRecordLabel: {
            ...
            type: 'Formula',
            defaultValue: { type: 'f', code: "context.mapping?.['label'] ?? context.mapping?.['name'] ?? context.mapping?.['title']" },
            section: 'settings',
            /* wwEditor:start */
            bindingValidation: { type: 'formula', tooltip: 'Formula to extract the record display label' },
            propertyHelp: {
                tooltip:
                    'Mapping to the record display name.\n\nExample mapping: `context.mapping?.["label"]`\nExample value: `Complete design document`',
            },
            /* wwEditor:end */
            hidden: (content, _, boundProps) => !content.mentionEnabled || !boundProps.mentionRecordTypes,
        },
        ...
        mappingRecordAvatar: {
            ...
            type: 'Formula',
            defaultValue: { type: 'f', code: "context.mapping?.['avatar'] ?? context.mapping?.['icon'] ?? context.mapping?.['image']" },
            section: 'settings',
            /* wwEditor:start */
            bindingValidation: { type: 'formula', tooltip: 'Formula to extract the record avatar/icon URL' },
            propertyHelp: {
                tooltip:
                    'Mapping to the record avatar or icon URL.\n\nExample mapping: `context.mapping?.["avatar"]`\nExample value: `https://example.com/task-icon.png`',
            },
            /* wwEditor:end */
            hidden: (content, _, boundProps) => !content.mentionEnabled || !boundProps.mentionRecordTypes,
        },
        ...
        mappingRecordMetadata: {
            ...
            type: 'Formula',
            defaultValue: { type: 'f', code: "context.mapping?.['metadata'] ?? context.mapping?.['data'] ?? context.mapping" },
            section: 'settings',
            /* wwEditor:start */
            bindingValidation: { type: 'formula', tooltip: 'Formula to extract additional record metadata' },
            propertyHelp: {
                tooltip:
                    'Mapping to additional record data/metadata.\n\nExample mapping: `context.mapping?.["metadata"]`\nExample value: `{ status: "in-progress", priority: "high" }`',
            },
            /* wwEditor:end */
            hidden: (content, _, boundProps) => !content.mentionEnabled || !boundProps.mentionRecordTypes,
        },
        ...
        mappingMessageMentions: {
            ...
            options: content => {
                const messages = Array.isArray(content.messages) ? content.messages : [];
                const mapping = content?.mappingMentions;
                return { template: __pickTemplateMessageByMapping(messages, mapping) };
            },
            defaultValue: { type: 'f', code: "context.mapping?.['mentions']" },
            section: 'settings',
            /* wwEditor:start */
            bindingValidation: { type: 'formula', tooltip: 'Formula to extract mentions array from message objects' },
            propertyHelp: {
                tooltip:
                    'Mapping to the mentions array in incoming messages.\n\nExample mapping: `context.mapping?.["mentions"]`\nExample value:\n```json\n[{\n  "recordTypeId": "tasks",\n  "recordId": "task-1",\n  "recordLabel": "Complete design",\n  "recordData": {}\n}]\n```',
            },
            /* wwEditor:end */
            hidden: (content, _, boundProps) => !content.mentionEnabled || !boundProps.messages,
        },
        ...
        mentionIcon: {
            ...
            /* wwEditor:start */
            bindingValidation: { type: 'string', tooltip: 'Icon for the mention button' },
            propertyHelp: {
                tooltip:
                    'Icon used for the mention button.\n\nExample: `lucide/at-sign`, `lucide/hash`',
            },
            /* wwEditor:end */
            hidden: content => !content.mentionEnabled,
        },
        ...
        mentionIconColor: {
            ...
            defaultValue: '#334155',
            /* wwEditor:start */
            bindingValidation: { type: 'string', tooltip: 'Color of the mention button icon' },
            propertyHelp: {
                tooltip:
                    'Mention button icon color.\n\nExample: `#334155`',
            },
            /* wwEditor:end */
            hidden: content => !content.mentionEnabled,
        },
        ...
        mentionIconSize: {
            ...
            defaultValue: '20px',
            /* wwEditor:start */
            bindingValidation: { type: 'string', tooltip: 'Size of the mention button icon' },
            propertyHelp: {
                tooltip:
                    'Mention button icon size.\n\nExample: `20px`',
            },
            /* wwEditor:end */
            hidden: content => !content.mentionEnabled,
        },
        ...
        mentionButtonBgColor: {
            ...
            defaultValue: '#f8fafc',
            /* wwEditor:start */
            bindingValidation: { type: 'string', tooltip: 'Background for the mention button' },
            propertyHelp: {
                tooltip:
                    'Background color of mention button.\n\nExample: `#f8fafc`',
            },
            /* wwEditor:end */
            hidden: content => !content.mentionEnabled,
        },
        ...
        mentionButtonHoverBgColor: {
            ...
            defaultValue: '#f1f5f9',
            /* wwEditor:start */
            bindingValidation: { type: 'string', tooltip: 'Hover background for the mention button' },
            propertyHelp: {
                tooltip:
                    'Background color of mention button on hover.\n\nExample: `#f1f5f9`',
            },
            /* wwEditor:end */
            hidden: content => !content.mentionEnabled,
        },
        ...
        mentionButtonBorder: {
            ...
            defaultValue: '1px solid #e2e8f0',
            /* wwEditor:start */
            bindingValidation: { type: 'string', tooltip: 'Border for the mention button' },
            propertyHelp: {
                tooltip:
                    'Border of mention button.\n\nExample: `1px solid #e2e8f0`',
            },
            /* wwEditor:end */
            hidden: content => !content.mentionEnabled,
        },
        ...
        mentionButtonBorderRadius: {
            ...
            defaultValue: '12px',
            /* wwEditor:start */
            bindingValidation: { type: 'string', tooltip: 'Border radius of the mention button' },
            propertyHelp: {
                tooltip:
                    'Border radius of mention button.\n\nExample: `12px`, `8px`',
            },
            /* wwEditor:end */
            hidden: content => !content.mentionEnabled,
        },
        ...
        mentionButtonSize: {
            ...
            defaultValue: '42px',
            /* wwEditor:start */
            bindingValidation: { type: 'string', tooltip: 'Square size of the mention button' },
            propertyHelp: {
                tooltip:
                    'Width & height of mention button.\n\nExample: `42px`',
            },
            /* wwEditor:end */
            hidden: content => !content.mentionEnabled,
        },
        ...
        mentionButtonBoxShadow: {
            ...
            defaultValue: '0 1px 2px rgba(0, 0, 0, 0.06)',
            /* wwEditor:start */
            bindingValidation: { type: 'string', tooltip: 'Shadow applied to the mention button' },
            propertyHelp: {
                tooltip:
                    'Background shadow of mention button.\n\nExample: `0 1px 2px rgba(0,0,0,.06)`',
            },
            /* wwEditor:end */
            hidden: content => !content.mentionEnabled,
        },
        ...
        mentionDropdownBgColor: {
            ...
            defaultValue: '#ffffff',
            /* wwEditor:start */
            bindingValidation: { type: 'string', tooltip: 'Background color of the mention dropdown' },
            propertyHelp: {
                tooltip:
        ...
        mentionDropdownBorder: {
            ...
            defaultValue: '1px solid #e2e8f0',
            /* wwEditor:start */
            bindingValidation: { type: 'string', tooltip: 'Border of the mention dropdown' },
            propertyHelp: {
                tooltip:
                    'Dropdown border.\n\nExample: `1px solid #e2e8f0`',
            },
        ...
        mentionDropdownBorderRadius: {
            ...
            defaultValue: '12px',
            /* wwEditor:start */
            bindingValidation: { type: 'string', tooltip: 'Border radius of the mention dropdown' },
            propertyHelp: {
                tooltip:
                    'Dropdown corner roundness.\n\nExample: `12px`',
            },
            /* wwEditor:end */
            hidden: content => !content.mentionEnabled,
        },
        ...
        mentionDropdownBoxShadow: {
            ...
            /* wwEditor:start */
            bindingValidation: { type: 'string', tooltip: 'Shadow applied to the mention dropdown' },
            propertyHelp: {
                tooltip:
                    'Dropdown shadow.\n\nExample: `0 4px 12px rgba(0,0,0,.15)`',
            },
            /* wwEditor:end */
            hidden: content => !content.mentionEnabled,
        },
        ...
        mentionDropdownMaxHeight: {
            ...
            defaultValue: '300px',
            /* wwEditor:start */
            bindingValidation: { type: 'string', tooltip: 'Maximum height of the mention dropdown' },
            propertyHelp: {
                tooltip:
        ...
        mentionDropdownMaxWidth: {
            ...
            defaultValue: '400px',
            /* wwEditor:start */
            bindingValidation: { type: 'string', tooltip: 'Maximum width of the mention dropdown' },
            propertyHelp: {
                tooltip:
        ...
        mentionTabTextColor: {
            ...
            defaultValue: '#64748b',
            /* wwEditor:start */
            bindingValidation: { type: 'string', tooltip: 'Text color of inactive tabs' },
            propertyHelp: {
                tooltip:
        ...
        mentionTabActiveColor: {
            ...
            defaultValue: '#3b82f6',
            /* wwEditor:start */
            bindingValidation: { type: 'string', tooltip: 'Text color of active tab' },
            propertyHelp: {
                tooltip:
        ...
        mentionTabHoverColor: {
            ...
            defaultValue: '#334155',
            /* wwEditor:start */
            bindingValidation: { type: 'string', tooltip: 'Text color of tabs on hover' },
            propertyHelp: {
                tooltip:
        ...
        mentionRecordBgColor: {
            ...
            /* wwEditor:start */
            bindingValidation: { type: 'string', tooltip: 'Background color of record items' },
            propertyHelp: {
                tooltip:
                    'Record item background.\n\nExample: `transparent`',
            },
            /* wwEditor:end */
            hidden: content => !content.mentionEnabled,
        },
        ...
        mentionRecordHoverBgColor: {
            ...
            defaultValue: '#f1f5f9',
            /* wwEditor:start */
            bindingValidation: { type: 'string', tooltip: 'Background color of record items on hover' },
            propertyHelp: {
                tooltip:
                    'Record item background (hover).\n\nExample: `#f1f5f9`',
            },
            /* wwEditor:end */
            hidden: content => !content.mentionEnabled,
        },
        ...
        mentionRecordTextColor: {
            ...
            defaultValue: '#334155',
            /* wwEditor:start */
            bindingValidation: { type: 'string', tooltip: 'Text color of record items' },
            propertyHelp: {
                tooltip:
        ...
        mentionRecordFontSize: {
            ...
            defaultValue: '0.875rem',
            /* wwEditor:start */
            bindingValidation: { type: 'string', tooltip: 'Font size of record items' },
            propertyHelp: {
                tooltip:
                    'Record item font size.\n\nExample: `0.875rem`',
            },
            /* wwEditor:end */
            hidden: content => !content.mentionEnabled,
        },
